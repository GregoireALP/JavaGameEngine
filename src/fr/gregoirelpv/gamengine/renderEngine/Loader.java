...
public class Loader {
    ...
    public RawModel loadToVao(float[] positions, int[] indices, float[] textureCoords) {
        ...
        storeDataIntAttributeList(0, 3, positions);
        storeDataIntAttributeList(1, 2, textureCoords);
        unbindVAO();
    ...
    private void storeDataIntAttributeList(int attributeNumber, int coordonateSize,float[] data) {
